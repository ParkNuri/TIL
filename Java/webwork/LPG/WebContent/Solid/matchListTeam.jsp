...
<body>
  ...
  <div id="portfoliowrap">
    <div class="portfolio-centered container">
      <div class="recentitems portfolio row a0" data-animate="fadeIn">
      	<!--  -->
      	
      	
        <div class="portfolio-item graphic-design">HOME
          <div class="he-wrap tpl6">
            <img src="img/portfolio/portImg.JPG" alt="ÆÀ¾Úºí·³" >
            <div class="he-view" >	
              <div class="bg">
              	<h3 class="a1" data-animate="fadeInDown">HOME</h3>
                <h4 class="a1" data-animate="fadeInDown">ÆÀ¸í</h4>
              </div>
              <!-- he bg -->
            </div>
            <!-- he view -->
...
<!--         end col-12
		<div class="portfolio-item graphic-design">VS
          <div class="he-wrap tpl6">
            <img src="img/portfolio/portfolio_05.jpg" alt="">
            <div class="he-view">
              <div class="bg">
                <h3 class="a1" data-animate="fadeInDown">VS</h3>
              </div>
              he bg
            </div>
            he view
        ...
        <div class="portfolio-item graphic-design">AWAY
          <div class="he-wrap tpl6">
            <img src="img/portfolio/portfolio_03.jpg" alt="">
            <div class="he-view">
              <div class="bg">
                <h3 class="a1" data-animate="fadeInDown">AWAY</h3>
                <h4 class="a1" data-animate="fadeInDown">ÆÀ¸í</h4>
              </div>
              he bg
            </div>
